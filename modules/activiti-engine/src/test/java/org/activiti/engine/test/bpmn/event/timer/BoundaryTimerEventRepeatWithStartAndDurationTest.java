...
public class BoundaryTimerEventRepeatWithStartAndDurationTest extends PluggableActivitiTestCase {
  ...
  public void testRepeatWithStartAndDuration() throws Throwable {
    ...
    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("repeatWithStartAndDurationId", variables);
